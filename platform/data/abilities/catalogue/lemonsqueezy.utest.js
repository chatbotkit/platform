...
import templates from './lemonsqueezy'
...
const DEFINITION = join(__dirname, 'lemonsqueezy.openapi.yaml')
...
describe('litmus tests', () => {
  ...
  it('should reject invalid endpoints', async () => {
    const response = await fetch(
      'https://api.lemonsqueezy.com/v1/invalid-endpoint-that-does-not-exist',
      {
        headers: {
          Authorization: 'Bearer YOUR_ACCESS_TOKEN',
          Accept: 'application/vnd.api+json',
...
describe('templates', () => {
  ...
  const untestableTemplates = ['lemonsqueezy/api/call']
