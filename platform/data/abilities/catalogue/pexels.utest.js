...
const DEFINITION = join(__dirname, 'pexels.openapi.yaml')
...
describe('litmus tests', () => {
  ...
  it('should reject invalid endpoints', async () => {
    const response = await fetch(
      'https://api.pexels.com/invalid-endpoint-that-does-not-exist',
      {
        headers: {
          Authorization: 'test-api-key',
        },
...
describe('templates', () => {
  ...
  const untestableTemplates = ['pexels/api/call']
