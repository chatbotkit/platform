...
import templates from './brandfetch'
...
// @note load the local OpenAPI spec file since Brandfetch doesn't have a public spec
const DEFINITION = join(__dirname, 'brandfetch.openapi.yaml')
...
describe('litmus tests', () => {
  ...
  it('should reject invalid endpoints', async () => {
    const response = await fetch(
      'https://api.brandfetch.io/v2/invalid-endpoint-that-does-not-exist',
      {
        headers: {
          Authorization: 'Bearer YOUR_ACCESS_TOKEN',
        },
