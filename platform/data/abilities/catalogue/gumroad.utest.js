...
const DEFINITION = join(__dirname, 'gumroad.openapi.yaml')
...
describe('litmus tests', () => {
  ...
  it('should reject invalid endpoints', async () => {
    const response = await fetch(
      'https://api.gumroad.com/v2/invalid-endpoint-that-does-not-exist',
      {
        headers: {
          Authorization: 'Bearer YOUR_ACCESS_TOKEN',
          Accept: 'application/json',
...
describe('templates', () => {
  ...
  const untestableTemplates = ['gumroad/api/call']
