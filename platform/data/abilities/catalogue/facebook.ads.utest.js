...
import templates from './facebook.ads'
...
const DEFINITION = join(__dirname, 'facebook.ads.openapi.yaml')
...
describe('litmus tests', () => {
  it('should accept valid endpoints', async () => {
    const response = await fetch(
      'https://graph.facebook.com/v21.0/act_123456789/campaigns',
      {
        headers: {
  ...
  it('should reject invalid endpoints', async () => {
    const response = await fetch(
      'https://graph.facebook.com/v21.0/123456789/invalid-edge-that-does-not-exist',
      {
        headers: {
          Authorization: 'Bearer TOKEN',
        },
...
describe('templates', () => {
  ...
  const untestableTemplates = ['facebook/ads/api/call']
