...
import templates from './zoom.yaml'
...
const DEFINITION =
  'https://developers.zoom.us/api-specs/zoom-api/methods/ZoomMeetingAPI-spec.json'
...
describe('litmus tests', () => {
  ...
  it('should reject invalid endpoints', async () => {
    const response = await fetch(
      'https://api.zoom.us/v2/invalid-endpoint-that-does-not-exist',
      {
        headers: {
          Authorization: 'Bearer YOUR_ACCESS_TOKEN',
        },
