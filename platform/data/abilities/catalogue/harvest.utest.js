...
// @note using the jolicode harvest-openapi-generator spec
const DEFINITION =
  'https://raw.githubusercontent.com/jolicode/harvest-openapi-generator/9635528535817f73568154fde8aba353f3cdb288/generated/harvest-openapi.yaml'
...
describe('litmus tests', () => {
  ...
  it('should reject invalid endpoints', async () => {
    const response = await fetch(
      'https://api.harvestapp.com/v2/invalid-endpoint-that-does-not-exist',
      {
        headers: {
          Authorization: 'Bearer YOUR_ACCESS_TOKEN',
          'Harvest-Account-Id': '12345',
...
describe('templates', () => {
  ...
  const untestableTemplates = ['harvest/api/call']
