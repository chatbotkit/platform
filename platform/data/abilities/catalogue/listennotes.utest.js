...
import templates from './listennotes'
...
// @see https://api.apis.guru/v2/specs/listennotes.com/2.0/openapi.json
const DEFINITION =
...
describe('litmus tests', () => {
  it('should accept valid endpoints', async () => {
    const response = await fetch(
      'https://listen-api.listennotes.com/api/v2/search?q=tech',
      {
        headers: {
          'X-ListenAPI-Key': 'YOUR_ACCESS_TOKEN',
        },
      }
    )
  ...
  it('should reject invalid endpoints', async () => {
    const response = await fetch(
      'https://listen-api.listennotes.com/api/v2/invalid-endpoint-that-does-not-exist',
      {
        headers: {
          'X-ListenAPI-Key': 'YOUR_ACCESS_TOKEN',
        },
