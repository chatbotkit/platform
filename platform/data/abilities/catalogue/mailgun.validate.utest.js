...
import templates from './mailgun.validate'
...
const DEFINITION =
  'https://documentation.mailgun.com/_spec/docs/validate/oas/openapi-validate-final.yaml'
...
describe('templates', () => {
  ...
  // @note all templates in this file should be testable against the validation API spec
