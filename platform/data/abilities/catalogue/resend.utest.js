...
const DEFINITION =
  'https://raw.githubusercontent.com/resend/resend-openapi/f6f0659872fe72f9e94a7137918801a7c5dd340f/resend.yaml'
...
describe('litmus tests', () => {
  ...
  it('should reject invalid endpoints', async () => {
    const response = await fetch(
      'https://api.resend.com/invalid-endpoint-that-does-not-exist',
      {
        headers: {
          Authorization: 'Bearer YOUR_ACCESS_TOKEN',
        },
