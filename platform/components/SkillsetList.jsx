...
const DEFAULT_LIST_ROUTE = '/api/v1/skillset/list'

const SKILLSET_LIST_QUERY = `
  query ResourceListSkillsets(
    $first: Int
    $last: Int
    $after: ID
    $before: ID
...
export default function SkillsetList({
  ...
  exportRoute = null, // '/api/v1/skillset/export',

  deleteRoute = '/api/v1/skillset/[id]/delete',

  instanceRoute = '/skillsets/[id]',
