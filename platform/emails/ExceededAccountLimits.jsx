...
export default function ExceededAccountLimits({
  limits,
  ...
  return (
    <BrandedEmail preview="Your account has exceeded its limits.">
      <Text>Dear customer,</Text>
      <Text>
        We hope this email finds you well. We are writing to inform you that
        your account has exceeded <strong>({joinWithAnd(niceLimits)})</strong>{' '}
        account limits. As a result, you may have experienced some limitations
        with your account when making requests to our API.
      </Text>
      {upgradeAvailable ? (
        <Text>
...
ExceededAccountLimits.subject = 'Exceeded Account Limits'

ExceededAccountLimits.PreviewProps = {}
