...
export default function NearlyExceededAccountLimits({
  limits,
  ...
  return (
    <BrandedEmail preview="Your account is close to exceeding its limits.">
      ...
      <Text>
        ...
        your account is close to exceeding some account limits{' '}
...
NearlyExceededAccountLimits.subject = 'Nearly Exceeded Account Limits'

NearlyExceededAccountLimits.PreviewProps = {}
