...
export default function ExceededDatabaseLimits({
  limits,
  ...
  return (
    <BrandedEmail preview="Your account has exceeded its limits.">
      ...
      <Text>
        ...
        your account has exceeded some database limits{' '}
...
ExceededDatabaseLimits.subject = 'Exceeded Account Limits'

ExceededDatabaseLimits.PreviewProps = {}
