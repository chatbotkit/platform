...
export default function ExceededRateLimits({
  limits,
  ...
  return (
    <BrandedEmail preview="Your account has exceeded its rate limits.">
      <Text>Dear customer,</Text>
      <Text>
        We hope this email finds you well. We are writing to inform you that
        your account has exceeded some rate limits{' '}
      ...
      {upgradeAvailable ? (
        <Text>
          ...
          higher rate limits. This will allow you to continue using our service
          without any interruptions.
        </Text>
      ) : null}
      <Button href={`${process.env.SITE_URL}/usage`}>
        See Your Rate Limits
      </Button>
      <Text>
...
ExceededRateLimits.subject = 'Exceeded Rate Limits'

ExceededRateLimits.PreviewProps = {}
