...
describe('bodySchema', () => {
  it('should accept valid upvote value in range', () => {
  ...
  it('should accept optional reason string', () => {
    const result = bodySchema.validate({ value: 100, reason: 'Very helpful' })
  ...
  it('should accept null reason', () => {
    const result = bodySchema.validate({ value: 100, reason: null })

    expect(result.error).toBeUndefined()
  })

  it('should accept empty string reason', () => {
    const result = bodySchema.validate({ value: 100, reason: '' })

    expect(result.error).toBeUndefined()
  })
})

describe('/api/v1/conversation/[conversationId]/upvote', () => {
  const mockSession = {
    user: {
      id: 'user_123',
    },
  ...
  describe('basic functionality', () => {
    it('should upvote conversation and return its id', async () => {
