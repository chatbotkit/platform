...
import handler from '@/pages/api/v1/integration/messenger/[messengerIntegrationId]/update'
...
describe('POST /api/v1/integration/messenger/[messengerIntegrationId]/update', () => {
  const mockSession = {
    user: {
      id: 'user-123',
  ...
  describe('basic functionality', () => {
    it('should update messenger integration successfully', async () => {
      prisma.messengerIntegration.findUniqueByIdentifier.mockResolvedValue(
        mockMessengerIntegration
      )
      prisma.messengerIntegration.update.mockResolvedValue({
        id: 'messenger-123',
      })
    ...
    it('should call update with correct parameters', async () => {
      ...
      expect(prisma.messengerIntegration.update).toHaveBeenCalledWith({
  ...
  describe('access token sentinel handling', () => {
    it('should preserve existing token when sentinel "********" is provided', async () => {
      ...
      const updateCall = prisma.messengerIntegration.update.mock.calls[0][0]
  ...
  describe('authorization', () => {
    it('should return 404 when integration not found', async () => {
      ...
      expect(prisma.messengerIntegration.update).not.toHaveBeenCalled()
    })
  ...
  describe('error handling', () => {
    it('should handle database errors during update', async () => {
      ...
      prisma.messengerIntegration.update.mockRejectedValue(
