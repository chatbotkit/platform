import { listDatabasesHandler } from '@chatbotkit-dev/auxiliary-notion'
...
export default authenticatedHandler(
  ...
  async function (_session, parameters, headers) {
    debug(`notion/database/list`, { parameters, headers }).log(
      'auxiliary.skillset.ability.notion.database.list'
    )
    ...
    return await listDatabasesHandler({
      token: token,
      startCursor:
