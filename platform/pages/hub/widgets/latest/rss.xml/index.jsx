    ...
    toXML(
      {
        ...
        _content: {
          channel: [
            {
              title: 'ChatBotKit Latest Hub Widgets',
            },
            {
              description: `The latest widgets on the ChatBotKit Hub`,
            },
            {
              link: `${process.env.SITE_URL}/hub/widgets/latest`,
            },
            {
              'atom:link': {
                _attrs: {
                  href: `${process.env.SITE_URL}/hub/widgets/latest/rss.xml`,
                  rel: 'self',
            ...
            ...all.map((item) => ({
              item: [
                ...
                {
                  link: `${process.env.SITE_URL}/hub/widgets/${
                    item.slug || item.id
                  }`,
                },
                ...getEnclosure(item),
