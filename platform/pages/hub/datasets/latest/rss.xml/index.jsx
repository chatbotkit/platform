    ...
    toXML(
      {
        ...
        _content: {
          channel: [
            {
              title: 'ChatBotKit Latest Hub Datasets',
            },
            {
              description: `The latest datasets on the ChatBotKit Hub`,
            },
            {
              link: `${process.env.SITE_URL}/hub/datasets/latest`,
            },
            {
              'atom:link': {
                _attrs: {
                  href: `${process.env.SITE_URL}/hub/datasets/latest/rss.xml`,
                  rel: 'self',
            ...
            ...all.map((item) => ({
              item: [
                ...
                {
                  link: `${process.env.SITE_URL}/hub/datasets/${
                    item.slug || item.id
                  }`,
                },
                ...getEnclosure(item),
