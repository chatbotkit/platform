...
jest.mock(
  '@/components/DatasetRecordList',
  () =>
    function DatasetRecordList() {
      return null
    }
)
jest.mock(
...
describe('Dataset Bots', () => {
  ...
  it('offers to link a bot when the dataset has none', () => {
    render(<Bots dataset={{ id: 'dataset_123', bots: [] }} />)
  ...
  it('links the selected bot to the dataset', async () => {
    mockFetch
  ...
  it('keeps the dataset unlinked when the update fails', async () => {
  ...
  it('offers to unlink the bot which already uses the dataset', () => {
    render(
      <Bots
        dataset={{
          id: 'dataset_123',
  ...
  it('unlinks the bot from the dataset', async () => {
