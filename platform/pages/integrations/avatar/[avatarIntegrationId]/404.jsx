...
export default function P404({ avatarIntegrationId }) {
  return (
    <>
      <Console
        message={`
...
This ChatBotKit Avatar integration is not available!

Avatar Integration ID: ${avatarIntegrationId}
`}
      />
...
export async function getServerSideProps(context) {
  return {
    props: makeJsonSafe({
      avatarIntegrationId: context.params.avatarIntegrationId,
    }),
  }
}
