...
/**
 * Resolves the provider-side model name for the Z.AI API.
 */
...
/**
 * Builds the chat messages payload for the Z.AI API.
 */
...
/**
 * Creates a chat completion using Z.AI API
 */
...
/**
 * Creates a streaming chat completion using Z.AI API
 */
