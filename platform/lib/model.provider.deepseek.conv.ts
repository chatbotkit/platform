...
import { createChatCompletionStream } from '@/lib/model.provider.deepseek.adaptor'
import {
...
interface DeepSeekConversationOptions extends ConversationInput {
...
export async function* completeChatConversation(
  options: Omit<DeepSeekConversationOptions, 'createChatCompletionStream'>
): ConversationOutput {
