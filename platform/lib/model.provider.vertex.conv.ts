...
import { createChatCompletionStream } from '@/lib/model.provider.vertex.adaptor'

interface VertexConversationOptions extends ConversationInput {
...
export async function* completeChatConversation(
  options: Omit<VertexConversationOptions, 'createChatCompletionStream'>
): ConversationOutput {
