...
const describeIfConfigured = hasLanguageModelsByProvider('deepseek')
  ? describe
  : describe.skip

describeIfConfigured('createChatCompletion', () => {
  it.skip('must correctly complete chat', async () => {
  ...
  it.skip('must correctly interpret chat and tool calls', async () => {
