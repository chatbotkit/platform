...
/**
 * Resolves the provider-side model name for the Qwen API.
 */
...
/**
 * Builds the chat messages payload for the Qwen API.
 */
...
/**
 * Creates a chat completion using Qwen API
 */
...
/**
 * Creates a streaming chat completion using Qwen API
 */
