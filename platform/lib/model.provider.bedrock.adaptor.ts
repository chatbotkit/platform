...
} from '@/lib/model.provider.bedrock'
...
/**
 * Resolves the provider-side model name for the Bedrock API.
 */
...
/**
 * Builds the chat messages payload for the Bedrock API.
 */
...
/**
 * Creates a chat completion using Bedrock API
 */
...
/**
 * Creates a streaming chat completion using Bedrock API
 */
