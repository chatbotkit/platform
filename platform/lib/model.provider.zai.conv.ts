...
import { createChatCompletionStream } from '@/lib/model.provider.zai.adaptor'
import {
...
interface ZaiConversationOptions extends ConversationInput {
...
export async function* completeChatConversation(
  options: Omit<ZaiConversationOptions, 'createChatCompletionStream'>
): ConversationOutput {
