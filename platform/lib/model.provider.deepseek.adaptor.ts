...
} from '@/lib/model.provider.deepseek'
...
/**
 * Resolves the provider-side model name for the DeepSeek API.
 */
...
/**
 * Builds the chat messages payload for the DeepSeek API.
 */
...
/**
 * Creates a streaming chat completion using DeepSeek API
 */
