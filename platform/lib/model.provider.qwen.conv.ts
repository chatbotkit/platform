...
import { createChatCompletionStream } from '@/lib/model.provider.qwen.adaptor'
import {
...
interface QwenConversationOptions extends ConversationInput {
...
export async function* completeChatConversation(
  options: Omit<QwenConversationOptions, 'createChatCompletionStream'>
): ConversationOutput {
