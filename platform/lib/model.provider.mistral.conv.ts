...
import { createChatCompletionStream } from '@/lib/model.provider.mistral.adaptor'
import {
...
interface MistralConversationOptions extends ConversationInput {
...
export async function* completeChatConversation(
  options: Omit<MistralConversationOptions, 'createChatCompletionStream'>
): ConversationOutput {
